...
Route::get("/startSchedule","AdminController@startSchedule");
...
//  Get Route to return the blocked dates report view
Route::get("/admin/blocked_dates_report" , "AdminController@blockedDatesReportView");
